namespace Dewit.Core.Enums
{
    ...
    {
        public static string ToDisplayName(this Mood mood) => mood switch
        {
        ...
        public static string ToSpectreColor(this Mood mood) => mood switch
        {
        ...
        public static string ToConfigKey(this Mood mood) => mood switch
        {
